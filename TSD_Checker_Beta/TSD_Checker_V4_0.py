...
class Application(QWidget):
    ...
    def ToggleLink(self):
        if self.tab2.RadioButtonInternet.isChecked() == True:
            ...
            self.DOC10Link = "http://docinfogroupe.inetpsa.com/ead/doc/ref.02043_18_05077/v.6.0/nPj.3"
            self.DOC11Link = "http://docinfogroupe.inetpsa.com/ead/doc/ref.02043_18_05077/v.6.0/nPj.2"
            self.DOC12Link = "http://docinfogroupe.inetpsa.com/ead/doc/ref.02043_18_05077/v.6.0/nPj.1"
            self.tab2.link2.setText('''<a href=''' + self.DOC8Link + '''>DocInfo Reference: 02043_18_05471</a>''')
            self.tab2.link1.setText('''<a href=''' + self.DOC9Link + '''>DocInfo Reference: 02043_18_05474</a>''')
            self.tab2.link3.setText('''<a href=''' + self.DOC7Link + '''>DocInfo Reference: 02043_18_05499</a>''')
            self.tab2.link4.setText('''<a href=''' + self.DOC13Link + '''>DocInfo Reference: 02016_11_04964</a>''')
...
class Test(Application):
    ...
    def buttonClicked(self):
        ...
        #GeneralStructure
            ...
            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0000"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0000(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0005"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0005(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0010"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0010(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0011"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0011(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0020"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0020(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0025"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0025(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0030"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0030(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0035"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0035(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0040"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0040(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0051"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0051(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0052"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0052(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0053"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0053(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0054"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0054(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0055"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0055(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0056"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0056(self.DOC3Workbook, self)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0057"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0057(self.DOC3Workbook, self)


            if archi_type == "Archi 2010":
                if self.DOC9Dict["Test_02043_18_04939_STRUCT_0058"][self.checkLevel].casefold().strip() is not "n/a":
                    GeneralStructureTester.Test_02043_18_04939_STRUCT_0058(self.DOC3Workbook, self)
                if self.DOC9Dict["Test_02043_18_04939_STRUCT_0061"][self.checkLevel].casefold().strip() is not "n/a":
                    GeneralStructureTester.Test_02043_18_04939_STRUCT_0061(self.DOC3Workbook, self)
            elif archi_type == "Archi NEA R1":
                if self.DOC9Dict["Test_02043_18_04939_STRUCT_0059"][self.checkLevel].casefold().strip() is not "n/a":
                    GeneralStructureTester.Test_02043_18_04939_STRUCT_0059(self.DOC3Workbook, self)
                if self.DOC9Dict["Test_02043_18_04939_STRUCT_0060"][self.checkLevel].casefold().strip() is not "n/a":
                    GeneralStructureTester.Test_02043_18_04939_STRUCT_0060(self.DOC3Workbook, self)
                if self.DOC9Dict["Test_02043_18_04939_STRUCT_0062"][self.checkLevel].casefold().strip() is not "n/a":
                    GeneralStructureTester.Test_02043_18_04939_STRUCT_0062(self.DOC3Workbook, self)
                if self.DOC9Dict["Test_02043_18_04939_STRUCT_0063"][self.checkLevel].casefold().strip() is not "n/a":
            ...
            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0100"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0100(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0110"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0110(self.excelApp, self.DOC3Workbook, self, self.DOC3Name)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0120"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0120(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0130"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0130(self.excelApp, self.DOC3Workbook, self, self.DOC3Name)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0140"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0140(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0150"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0150(self.excelApp, self.DOC3Workbook, self, self.DOC3Name)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0160"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0160(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0170"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0170(self.excelApp, self.DOC3Workbook, self, self.DOC3Name)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0180"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0180(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0190"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0190(self.excelApp, self.DOC3Workbook, self, self.DOC3Name)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0200"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0200(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0210"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0210(self.excelApp, self.DOC3Workbook, self, self.DOC3Name)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0220"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0220(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0230"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0230(self.excelApp, self.DOC3Workbook, self, self.DOC3Name)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0240"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0240(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0250"][self.checkLevel].casefold().strip() is not "n/a":
                GeneralStructureTester.Test_02043_18_04939_STRUCT_0250(self.excelApp, self.DOC3Workbook, self, self.DOC3Name)

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0260"][self.checkLevel].casefold().strip() is not "n/a":
                check = GeneralStructureTester.Test_02043_18_04939_STRUCT_0260(self.DOC3Workbook, self)
                if check == True:
                    ok = 1

            if self.DOC9Dict["Test_02043_18_04939_STRUCT_0270"][self.checkLevel].casefold().strip() is not "n/a":
        ...
        # Wholeness
            if ok == 0 or ok == 1:
                ...
                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1000"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1000(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1001"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1001(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1010"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1010(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1011"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1011(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1020"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1020(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1021"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1021(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1030"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1030(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1031"][self.checkLevel].casefold().strip() is not "n/a":
                ...
                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1050"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1050(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1055"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1055(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1060"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1060(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1061"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1061(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1062"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1062(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1070"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1070(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1080"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1080(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1090"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1090(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1100"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1100(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1110"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1110(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1120"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1120(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1130"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1130(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1040"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1140(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1150"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1150(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1160"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1160(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1170"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1170(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1180"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1180(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1190"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1190(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1200"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1200(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1210"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1210(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1220"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1220(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1230"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1230(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_STRUCT_1240"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1240(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1600"][self.checkLevel].casefold().strip() is not "n/a":
                ...
                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1602"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1602(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1603"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1603(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1604"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1604(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1605"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1605(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1606"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1606(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1607"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1607(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1608"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1608(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1609"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1609(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1610"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1610(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1611"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1611(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1612"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1612(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1613"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1613(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1615"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1615(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1616"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1616(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1617"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1617(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1618"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1618(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1619"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1619(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1620"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1620(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1621"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1621(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1622"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1622(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1623"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1623(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1624"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1624(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1625"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1625(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1626"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1626(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1627"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1627(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1628"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1628(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1629"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1629(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1630"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1630(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1631"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1631(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1632"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1632(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1650"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1650(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1651"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1651(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1652"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1652(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1653"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1653(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1654"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1654(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1655"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1655(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1656"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1656(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1657"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1657(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1658"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1658(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1659"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1659(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1660"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1660(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1661"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1661(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1662"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1662(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1663"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1663(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1664"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1664(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1684"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1684(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1685"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1685(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1686"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1686(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1687"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1687(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1688"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1688(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1689"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1689(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1690"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1690(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1691"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1691(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1692"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1692(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1693"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1693(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1700"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1700(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1701"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1701(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1702"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1702(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1703"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1703(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1704"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1704(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1705"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1705(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1706"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1706(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1707"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1707(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1708"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1708(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1709"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1709(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1710"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1710(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1711"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1711(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1712"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1712(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1713"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1713(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1714"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1714(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1715"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1715(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1716"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1716(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1717"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1717(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1718"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1718(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1719"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1719(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1750"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1750(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1751"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1751(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1752"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1752(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1753"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1753(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1754"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1754(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1755"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1755(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1756"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1756(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1757"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1757(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1758"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1758(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1759"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1759(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1800"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1800(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1801"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1801(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1802"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1802(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1803"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1803(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1810"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1810(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1811"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1811(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1812"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1812(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1813"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1813(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1814"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1814(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1815"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1815(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1820"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1820(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1821"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1821(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1822"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1822(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1823"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1823(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1824"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1824(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1825"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1825(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1830"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1830(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1831"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1831(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1840"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = WholenessTester.Test_02043_18_04939_WHOLENESS_1840(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_WHOLENESS_1841"][self.checkLevel].casefold().strip() is not "n/a":
                ...
                if self.DOC9Dict["Test_02043_18_04939_COH_2100"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2100(self.DOC3Workbook, self, self.DOC8List)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_COH_2110"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2110(self.DOC3Workbook, self, self.DOC8List)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_COH_2140"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2140(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_COH_2150"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2150(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_COH_2160"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2160(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_COH_2190"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2190(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_COH_2210"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2210(self.DOC3Workbook, self)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_COH_2230"][self.checkLevel].casefold().strip() is not "n/a":
                ...
                if self.DOC9Dict["Test_02043_18_04939_COH_2240"][self.checkLevel].casefold().strip() is not "n/a":
                    check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2240(self.DOC3Workbook, self, self.DOC13List)
                    if check_indicator == True:
                        ok_indicator = 1

                if self.DOC9Dict["Test_02043_18_04939_COH_2250"][self.checkLevel].casefold().strip() is not "n/a":
        ...
        if self.tab1.myTextBox2.toPlainText():
            ...
            self.DOC11Path = self.download_file(self.DOC11Link)
        ...
        if self.tab1.myTextBox3.toPlainText():
            ...
            self.DOC12Path = self.download_file(self.DOC12Link)
