    ...
    def buttonClicked(self):
        ...
        # Wholeness
            if ok == 0 or ok == 1:
                ...
                if "Test_02043_18_04939_COH_2060" in self.DOC9Dict:
