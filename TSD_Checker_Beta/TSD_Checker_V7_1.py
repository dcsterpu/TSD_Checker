...
class Test(Application):
    ...
    def buttonClicked(self):
        ...
        if not self.flag_load_configuration and not self.flag_opened_file:
        ...
        elif self.flag_load_configuration and not self.flag_opened_file:
        ...
        if self.DOC3Exists is True and not self.flag_opened_file:
        ...
        if self.DOC4Exists is True and not self.flag_opened_file:
        ...
        if self.DOC5Exists is True and not self.flag_opened_file:
