    ...
    def buttonClicked(self):
        ...
        # Wholeness
            if ok == 0:
                ...
                check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2006(self.excelApp, self.DOC3Workbook, self, self.DOC8Name)
                if check_indicator == True:
                    ok_indicator = 1
                ...
                check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2100(self.excelApp, self.DOC3Workbook, self, self.DOC8Name)
                if check_indicator == True:
                    ok_indicator = 1

                check_indicator = Coherence_checksTester.Test_02043_18_04939_COH_2110(self.excelApp, self.DOC3Workbook, self, self.DOC8Name)
                if check_indicator == True:
                    ok_indicator = 1
